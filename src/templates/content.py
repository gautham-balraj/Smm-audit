...
if __name__ == "__main__":
    ...
    cleaned_file_path = "StreamlitTempApp/data/output_generated_file/Product_output_cleaned.txt"
    # Output HTML file
    output_file = "StreamlitTempApp/src/templates/content_marketing.html"
...
if __name__ == "__main__":
    ...
    html_file_path = "StreamlitTempApp/src/templates/content_marketing.html"
